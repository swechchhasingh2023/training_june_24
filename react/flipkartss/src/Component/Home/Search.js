      ...
      <section>
        <div id="devCarousel" className="carousel slide" data-ride="carousel">
          ...
          <div className="carousel-inner">
            ...
            <div className="item">
              <img
                src="https://rukminim2.flixcart.com/fk-p-flap/1600/270/image/5aab8847f5e9869f.jpg?q=20"
                alt="slider"
                className="sliderImage"
              />
            </div>
            <div className="item">
              <img
                src="https://rukminim2.flixcart.com/fk-p-flap/1600/270/image/a4967bcc3d7e2c25.jpeg?q=20"
                alt="slider"
                className="sliderImage"
              />
            </div>
            <div className="item">
              <img
                src="https://rukminim2.flixcart.com/fk-p-flap/1600/270/image/693e9029da2a38d3.jpeg?q=20"
                alt="slider"
                className="sliderImage"
              />
            </div>
            <div className="item">
              <img
                src="https://rukminim2.flixcart.com/fk-p-flap/1600/270/image/0b258b0085c395ee.jpg?q=20"
                alt="slider"
                className="sliderImage"
              />
            </div>
